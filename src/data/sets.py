...
def split_sets_random(features, target, test_ratio=0.2):
    ...
    X_train, X_val, y_train, y_val = train_test_split(features, target, test_size=test_ratio, random_state=42, stratify=target)
    return X_train, y_train, X_val, y_val


def save_sets(X_train=None, y_train=None, X_val=None, y_val=None, X_test=None, path='../data/processed/'):
